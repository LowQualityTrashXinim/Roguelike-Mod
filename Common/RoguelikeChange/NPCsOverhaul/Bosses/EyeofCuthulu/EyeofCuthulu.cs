...
using Roguelike.Common.Graphics.AnimationSystems;
...
using Roguelike.Common.RoguelikeChange.NPCsOverhaul;
...
namespace Roguelike.Common.RoguelikeChange.NPCsOverhaul.Bosses.EyeofCuthulu;
