...
namespace Roguelike.Common.Systems.Element.ElementContent;
internal class ExampleElement : Element {
	...
	public override void OnHitNPC(Player player, Item item, Projectile projectile, NPC target, NPC.HitInfo info, HashSet<ushort> hash_elementType) {
		...
		//the add buff method wortk in tick so you will need to do 60 * 10 or do ModUtils.ToSecond(10) so that it work like you expected
	}
}
