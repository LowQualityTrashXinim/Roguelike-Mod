...
public abstract class ItemObject : ModObject {
	...
	public override void AI() {
		...
		if (Main.LocalPlayer.Center.IsCloseToPosition(Center, 50)) {
			Kill();
			Item item = Main.LocalPlayer.QuickSpawnItemDirect(new EntitySource_Misc("Object"), itemToDrop, Amount);
			OnDropItem(item);
		}
	}
	...
	public void BasicDrawItem(SpriteBatch spritebatch, int framecounter = 1) {
		...
		Texture2D texture = TextureAssets.Item[itemToDrop].Value;
