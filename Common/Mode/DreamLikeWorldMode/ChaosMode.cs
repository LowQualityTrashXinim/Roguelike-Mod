...
internal class ChaosModeSystem : ModSystem {
	...
	public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight) {
		...
		while (List_Ban_ItemID.Count < BannedItemIDCount) {
			repurposeID = Main.rand.NextFromHashSet(ModItemLib.List_Weapon).type;
		...
		HashSet<Item> listItemIDPossible = ModItemLib.List_Weapon.Where(i => !List_Ban_ItemID.Contains(i.type)).ToHashSet();
