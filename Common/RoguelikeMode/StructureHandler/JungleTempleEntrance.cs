...
internal class Structure_JungleTempleEntrance : ModStructure {
	public override void CreateStructure(Mod mod, RogueLikeWorldGen system) {
		int X = 11 * RogueLikeWorldGen.GridPart_X + RogueLikeWorldGen.Rand.Next(0, RogueLikeWorldGen.GridPart_X);
		int Y = 5 * RogueLikeWorldGen.GridPart_Y + RogueLikeWorldGen.Rand.Next(0, RogueLikeWorldGen.GridPart_Y);
		var data = ModWrapper.Get_StructureData("Assets/JungleTemple_Entrance", mod);
