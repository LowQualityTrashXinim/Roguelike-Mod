...
/// <summary>
/// AI0 : Distance<br/>
/// AI1 : Projectile amount<br/>
/// AI2 : Index<br/>
/// </summary>
public abstract class GhostYoyo2 : ModProjectile {
	public override string Texture => ModUtils.GetVanillaTexture<Projectile>(ProjectileID.WoodYoyo);
	public override void SetStaticDefaults() {
		ProjectileID.Sets.TrailingMode[Type] = 3;
		ProjectileID.Sets.TrailCacheLength[Type] = 15;
	}
	public virtual int ItemType => ItemID.WoodYoyo;
	public override void SetDefaults() {
		Projectile.CloneDefaults(ProjectileID.WoodYoyo);
		Projectile.aiStyle = -1;
		Projectile.usesLocalNPCImmunity = true;
	...
	public override void AI() {
		...
		Projectile.Center = player.Center + Vector2.One.RotatedBy(MathHelper.ToRadians(Projectile.timeLeft + 360 / Projectile.ai[1] * Projectile.ai[2])) * Projectile.ai[0];
	}
	public override bool PreDraw(ref Color lightColor) {
		Main.instance.LoadItem(ItemType);
		Texture2D yoyoTexture = TextureAssets.Item[ItemType].Value;
		Vector2 origin = yoyoTexture.Size() * .5f;
		Vector2 drawpos = Projectile.position - Main.screenPosition + origin;
		for (float i = 0; i < Projectile.oldPos.Length; i++) {
			Main.EntitySpriteDraw(yoyoTexture, Projectile.oldPos[(int)i] - Main.screenPosition + yoyoTexture.Size() / 2f, null, lightColor * MathHelper.Lerp(1f, 0f, i / Projectile.oldPos.Length), 0, yoyoTexture.Size() / 2f, 1f, SpriteEffects.None);
