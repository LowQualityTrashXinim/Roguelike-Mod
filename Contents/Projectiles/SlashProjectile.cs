...
internal class SlashProjectile : ModProjectile {
	...
	public Color Back_Color = new Color(160, 60, 180);
	public Color Middle_Color = new Color(255, 80, 255);
	public Color Front_Color = new Color(240, 150, 255);
	public override bool PreDraw(ref Color lightColor) {
		...
		Color backDarkColor = Back_Color; // Original Excalibur color: Color(180, 160, 60)
		Color middleMediumColor = Middle_Color; // Original Excalibur color: Color(255, 255, 80)
		Color frontLightColor = Front_Color; // Original Excalibur color: Color(255, 240, 150)
