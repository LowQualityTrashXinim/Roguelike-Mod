...
internal class SmartNeoDynamite : ModItem {
	public override string Texture => ModUtils.GetTheSameTextureAsEntity<NeoDynamite>();
...
class SmartNeoDynamiteExplosion : ModProjectile {
	public override string Texture => ModUtils.GetTheSameTextureAs<NeoDynamite>();
	public override void SetDefaults() {
		Projectile.width = 14;
	...
	public override void PostDraw(Color lightColor) {
		Texture2D texture = ModContent.Request<Texture2D>(ModUtils.GetTheSameTextureAs<NeoDynamite>("NeoDynamiteGlowMask"), AssetRequestMode.ImmediateLoad).Value;
