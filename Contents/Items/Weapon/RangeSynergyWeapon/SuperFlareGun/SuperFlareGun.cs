...
internal class SuperFlareGun : SynergyModItem {
	public override void Synergy_SetStaticDefaults() {
		...
		SynergyBonus_System.Add_SynergyBonus(Type, ItemID.Boomstick, $"[i:{ItemID.Boomstick}] On flare explode creating a ring of bullet");
	}
...
internal class SuperFlareP : ModProjectile {
	...
	public override void OnKill(int timeLeft) {
		...
		if (SynergyBonus_System.Check_SynergyBonus(ModContent.ItemType<SuperFlareGun>(), ItemID.Boomstick)) {
			for (int i = 0; i < 36; i++) {
