...
public class Hearty : RelicPrefix {
	public override void SetStaticDefaults() {
		TextureString = ModUtils.GetTheSameTextureAs<Relic>("HeartyRelic");
	}
...
public class Arcane : RelicPrefix {
	public override void SetStaticDefaults() {
		TextureString = ModUtils.GetTheSameTextureAs<Relic>("ArcaneRelic");
	}
	public override StatModifier StatsModifier(Player player, Relic relic, StatModifier value, int TemplateType, int index) {
		if (index != 0) {
			return value;
...
public class Alpha : RelicPrefix {
	public override void SetStaticDefaults() {
		TextureString = ModUtils.GetTheSameTextureAs<Relic>("AlphaRelic");
	}
	public override StatModifier StatsModifier(Player player, Relic relic, StatModifier value, int TemplateType, int index) {
		if (index != 0) {
			return value;
...
public class Zeta : RelicPrefix {
	public override void SetStaticDefaults() {
		TextureString = ModUtils.GetTheSameTextureAs<Relic>("ZetaRelic");
	}
	public override StatModifier StatsModifier(Player player, Relic relic, StatModifier value, int TemplateType, int index) {
