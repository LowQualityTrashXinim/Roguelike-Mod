...
public class ModPlayer_ShortSwordEnchantment : ModPlayer {
	...
	public override void ResetEffects() {
		...
		ShortSwordValue = ModUtils.CountDown(ShortSwordValue);
		ShortSwordCoolDownHit = ModUtils.CountDown(ShortSwordCoolDownHit);
	}
...
public class Enchantment_ShortSwordProjectile : ModProjectile {
	...
	public override void AI() {
		...
		var toward = Vector2.One.RotatedBy(MathHelper.ToRadians(Degree + player.GetModPlayer<ModUtilsPlayer>().counterToFullPi * 2));
	...
	public override bool PreDraw(ref Color lightColor) {
		...
		var texture = ModContent.Request<Texture2D>(ModUtils.GetVanillaTexture<Item>(ItemTextureID)).Value;
...
public class GoldShortSword : ModEnchantment {
	...
	public override void OnHitNPCWithItem(int index, Player player, EnchantmentGlobalItem globalItem, Item item, NPC target, NPC.HitInfo hit, int damageDone) {
		...
		if (Main.rand.NextBool(10)) {
			target.AddBuff(BuffID.Midas, ModUtils.ToSecond(Main.rand.Next(4, 6)));
		}
	}
	public override void OnHitNPCWithProj(int index, Player player, EnchantmentGlobalItem globalItem, Projectile proj, NPC target, NPC.HitInfo hit, int damageDone) {
		var modplayer = player.GetModPlayer<ModPlayer_ShortSwordEnchantment>();
